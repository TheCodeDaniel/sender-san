    ...
    <main className="max-w-6xl mx-auto px-6 py-8">
      <div className="relative mb-8">
        ...
        <h1 className="text-2xl font-semibold text-text-primary">
          こんにちは, <span className="text-secondary">{profile?.name ?? 'Developer'}</span>.
        </h1>
        ...
        <Card className="relative overflow-hidden">
          <div className="flex items-start justify-between mb-3">
            <div>
              ...
              <Tag color="default" className="mt-1">{profile?.career_level}</Tag>
            </div>
            <button onClick={() => setProfileExpanded(e => !e)} className="text-xs text-text-muted hover:text-text-primary transition-smooth">
          ...
          <button onClick={() => navigate('/setup')} className="mt-3 text-xs text-text-muted hover:text-text-primary transition-smooth">
            Edit profile →
          </button>
        </Card>
